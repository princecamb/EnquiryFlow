		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Enquiryworkflowworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Enquiryworkflowworkflowuimodule-display": {
								"semanticObject": "Enquiryworkflowworkflowuimodule",
								"action": "display",
								"description": "A workflow task for Enquiry ",
								"title": "Task UI app title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Enquiryworkflow.workflowuimodule",
									"url": sap.ui.require.toUrl("Enquiryworkflow/workflowuimodule")
								}
							}
						}
					}
